	...
	<header class="top-navbar">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <h3>
					...
					{
					?>
					Hi <?php echo $_SESSION['uid']; ?> &nbsp;&nbsp;&nbsp;&nbsp; <a href="cart.php" style="color: green;" >CART</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="logout.php">LOGOUT</a>
					<?php	
					}
					else
					{	
            ...
            <li class="nav-item"><a class="nav-link" href="idorder.php">Order</a></li>
